$(() => {
  ...
  function createListing(property, isReservation) {
    console.log('property === ', moment(property.start_date).format('ll'));
    return `
        ...
        <section class="property-listing__details">
          ...
          <footer class="property-listing__footer">
            ...
            ${isReservation.upcoming ? 
              `<button id="update-property-${property.reservation_id}" class="update-button">Update</button>
              <button id="delete-property-${property.reservation_id}" class="delete-button">Delete</button>
              ` : ``
            }
